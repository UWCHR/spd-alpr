...
Visual inspection of the bivariate relationship between plate read frequency (`r_freq`) and estimated median household income per zipcode (`median_incomeE`) does not show an obvious trend:
